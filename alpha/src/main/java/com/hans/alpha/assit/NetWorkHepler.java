...
public class NetWorkHepler {
    public static final String TAG = "MotherShip.NetWorkHepler";
    ...
    public static String getNetworkTypeName(Context context) {
        ...
        Log.d(TAG, "[getNetworkTypeName] type:%s", type);
        return type;
    }
    ...
    public static boolean isWifiConnected(Context context) {
        if (context != null) {
            return "WIFI".equalsIgnoreCase(getNetworkTypeName(context));
        }
        return false;
    }
}
