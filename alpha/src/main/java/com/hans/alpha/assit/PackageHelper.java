...
import com.hans.alpha.utils.ShellUtil;
 ...
 * <li>{@link PackageHelper#installSilent(Context, String)}</li>
 * <li>{@link PackageHelper#install(Context, String)}</li>
 * </ul>
 * <ul>
 ...
 * <li>{@link PackageHelper#uninstall(Context, String)}</li>
 * </ul>
 * <ul>
 ...
 * <li>{@link PackageHelper#getInstallLocation()} get system install location</li>
...
public class PackageHelper {
    ...
    public static final String TAG = "MotherShip.PackageHelper";
    ...
    public static final int install(Context context, String filePath) {
        if (PackageHelper.isSystemApplication(context) || ShellUtil.checkRootPermission()) {
     ...
     * @param context
     * @param filePath file path of package
     * @return {@link PackageHelper#INSTALL_SUCCEEDED} means install success, other means failed. details see
     *         {@link PackageHelper}.INSTALL_FAILED_*. same to {@link PackageManager}.INSTALL_*
