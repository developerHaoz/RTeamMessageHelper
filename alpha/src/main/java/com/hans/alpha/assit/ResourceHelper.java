...
public class ResourceHelper {
    ...
    public static String geFileFromAssets(Context context, String fileName) {
        if (context == null || StringUtil.isEmpty(fileName)) {
            Log.d(TAG,"[geFileFromAssets] context is null or fileName is null");
            return null;
        }
        Log.d(TAG,"[geFileFromAssets] fileName:%s",fileName);
        ...
        try {
            ...
            Log.d(TAG,"[geFileFromAssets] result:%s",s.toString());
            return s.toString();
        } catch (IOException e) {
            e.printStackTrace();
            return null;
    ...
    public static String geFileFromRaw(Context context, int resId) {
        if (context == null) {
            Log.d(TAG,"[geFileFromRaw] context is null");
            return null;
        }
        ...
        try {
            ...
            Log.d(TAG,"[geFileFromRaw] result:%s",s.toString());
            return s.toString();
        } catch (IOException e) {
            e.printStackTrace();
            return null;
    ...
    /**
     * same to {@link ResourceHelper#geFileFromAssets(Context, String)}, but return type is List<String>
     * 
     * @param context
     * @param fileName
     * @return
    ...
    /**
     * same to {@link ResourceHelper#geFileFromRaw(Context, int)}, but return type is List<String>
     * 
     * @param context
     * @param resId
     * @return
