...
public abstract interface MotherShipConst {

	public static abstract interface Base{
		public static final String EXCEPTION="exception";
	}

	public static abstract interface TestType {
		public static final int TYPE_1 = 0X10;
		public static final int TYPE_2 = 0X20;
		public static final int TYPE_3 = 0X30;
	}
	...
	public static abstract interface Strings {
		public static final String METCH_PATTERN_REGEX = "[\\*]+";
		public static final String METCH_PATTERN = MotherShipConst.Symbol.WILDCARD;
		public static final String METCH_PATTERN_REPLACEMENT = "[\\\\S|\\\\s]*";
	...
	public static abstract interface OK_REQUEST{
		public static final String KEY_REQUEST_CALLBACK = "KEY_REQUEST_CALLBACK";
		public static final String KEY_REQUEST_DOSCENE_TYPE = "KEY_REQUEST_DOSCENE_TYPE";
	}
	public static abstract interface DOWNLOAD_CONST{
