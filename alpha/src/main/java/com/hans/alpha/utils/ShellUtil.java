...
public class ShellUtil {
    ...
    private static final String TAG = "MotherShip.ShellUtil";
    ...
    public static CommandResult execCommand(String[] commands, boolean isRoot, boolean isNeedResultMsg) {
        Log.d(TAG,"[execCommand] commands:%s, isRoot:&s, isNeedResultMsg:%s",commands, isRoot,isNeedResultMsg);
        int result = -1;
        ...
        CommandResult temp = new CommandResult(result, successMsg == null ? null : successMsg.toString(), errorMsg == null ? null
                : errorMsg.toString());
        Log.d(TAG,"[execCommand] %s",temp.toString());
        return temp;
    }
